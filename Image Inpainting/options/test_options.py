...
class TestOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--data_file', type=str, default='D:/chrome_download/inpainting_gmcnn-master/inpainting_gmcnn-master/pytorch/places_test.flist', help='the file storing testing file paths')
        self.parser.add_argument('--test_dir', type=str, default='./test_results', help='models are saved here')
        self.parser.add_argument('--load_model_dir', type=str, default='D:/chrome_download/checkpoints', help='pretrained models are given here')
        ...
        self.parser.add_argument('--test_num', type=int, default=100)
