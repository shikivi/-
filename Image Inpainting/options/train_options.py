...
class TrainOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--data_file', type=str, default='D:/chrome_download/inpainting_gmcnn-master/inpainting_gmcnn-master/pytorch/places_test.flist', help='the file storing training image paths')
        ...
        self.parser.add_argument('--train_spe', type=int, default=700)
        self.parser.add_argument('--epochs', type=int, default=40)
        self.parser.add_argument('--viz_steps', type=int, default=1)
